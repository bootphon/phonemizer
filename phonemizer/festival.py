...
"""Provides the FestivalPhonemizer class"""
...
from . import lispy
from .phonemizer import InterfacePhonemizer


class FestivalPhonemizer(InterfacePhonemizer):
    ...
    def _phonemize(self, text):
        ...
        Any opening and closing parenthesis are removed, as they
        interfer with the Scheme expression syntax. Moreover double
        quotes are replaced by simple quotes because double quotes
        denotes utterances boundaries in festival.
