...
class Punctuation:
    ...
    @classmethod
    def restore(cls, text, marks, sep, strip):
    ...
    @classmethod
    def _restore_current(cls, current, text, marks, num, sep, strip):
        ...
        mark = re.sub(r'\s', sep.word, current.mark)
    ...
    @classmethod
    def _restore_aux(cls, text, marks, num, sep, strip):
